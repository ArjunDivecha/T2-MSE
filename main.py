...
def main():
    ...
    print("🚀 Starting T2 MSE Factor Selection System")
    print("=" * 60)
    
    # Check if hyperparameter results exist
    hyperparam_file = 'outputs/hyperparam_MSE_results.csv'
    ...
    try:
        ...
        print(f"\n📊 Outputs generated:")
        print(f"   • Monthly Forecasts: outputs/T60_Enhanced_MSE.xlsx")
        print(f"   • Backtest Results: outputs/backtest_MSE_results.csv")
        print(f"   • Hyperparameter Results: outputs/hyperparam_MSE_results.csv")
