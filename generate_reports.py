...
def load_results():
    ...
    results_df = pd.read_csv('outputs/backtest_MSE_results.csv')
    results_df['date'] = pd.to_datetime(results_df['date'])
    results_df = results_df.sort_values('date')
    
    # Load analysis
    analysis_df = pd.read_csv('outputs/backtest_MSE_analysis.csv')
...
def create_excel_report(results_df, metrics, factor_analysis, output_file='outputs/Performance_MSE_Report.xlsx'):
...
def generate_pdf_report(results_df, metrics, factor_analysis, output_file='outputs/Performance_MSE_Report.pdf'):
    ...
    try:
        ...
        with PdfPages(output_file) as pdf:
            ...
            ax.text(0.5, 0.95, 'T2 MSE Factor Selection', 
...
def main():
    ...
    print("\n📊 Generated outputs:")
    print("   • Performance_MSE_Report.xlsx - Comprehensive Excel analysis")
    print("   • Performance_MSE_Report.pdf - Executive summary report") 
